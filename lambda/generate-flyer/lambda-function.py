...
def generate_flyer_content(business, prompt, platforms):
    ...
    marketing_prompt = (
        ...
        '{{\n'
        '  "title": "Flyer headline directly based on the user request",\n'
        '  "caption": "Detailed marketing copy that addresses the user request",\n'
        '  "offer": "Special offer or value proposition from the user request",\n'
        '  "call_to_action": "Short CTA relevant to the user request",\n'
        '  "image_prompt": "Detailed visual description matching the user request"\n'
        '}}'
    )
