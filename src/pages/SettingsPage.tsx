...
import type { User, SocialConnection } from "../services/api";
...
export default function SettingsPage() {
  ...
  useEffect(() => {
    if (activeTab === 1) fetchConnections();
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [activeTab]);

  // ── URL param check (LinkedIn OAuth redirect back) ──
    ...
    <Box sx={{ height: "100vh", bgcolor: "#0d0d0f", display: "flex", flexDirection: "column" }}>
              ...
              <Box sx={{ display: "flex", flexDirection: "column", gap: 2, maxWidth: 640 }}>
                ...
                >
                  <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
                    ...
                    <Box>
                      <Typography sx={{ color: "#e0dcf8", fontWeight: 600, fontSize: 15 }}>
                        LinkedIn
                      </Typography>
                      {linkedinConnection ? (
                        <>
      ...
      >
        ...
        <DialogContent sx={{ px: { xs: 3, sm: 4 }, pt: "24px !important", pb: 2 }}>
          <Box sx={{ mb: 2.5 }}>
            <Typography sx={{ color: "#5140d0", fontSize: 13, fontWeight: 600, mb: 0.8 }}>
              Email Address
            </Typography>
            <TextField
              type="email"
              ...
              sx={{
                ...
                "& .MuiFormHelperText-root": { color: "#ef4444", fontSize: 12, mx: 0, mt: 0.6 },
              }}
        ...
        <DialogActions sx={{ px: { xs: 3, sm: 4 }, py: 2.5, gap: 1.5 }}>
          <Button
            ...
            sx={{
              ...
              "&:hover": { bgcolor: "rgba(255,255,255,0.06)", borderColor: "#7070a0", color: "#070707" },
            }}
          >
            Cancel
          </Button>
          <Button
            ...
            disabled={
              submitting ||
              (!editingUser && (!form.email.trim() || !form.displayName.trim() || !form.businessId.trim()))
            }
            variant="contained"
            sx={{
              bgcolor: "#a78bfa",
      ...
      {/* Toast notifications (LinkedIn OAuth result) */}
      <Snackbar
        open={snackbar.open}
